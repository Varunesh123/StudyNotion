...
function Home() {
  return (
    <div>
      <div className='relative mx-auto flex flex-col items-center justify-between w-11/12 max-w-maxContent gap-8 text-white'> 
        <Link to='/signup'>
            <div className='group mx-auto m-16 w-fit rounded-full bg-richblack-800 p-1 font-bold text-richblack-200 drop-shadow-[0_1.5px_rgba(255,255,255,0.25)] transition-all duration-200 hover:scale-95 hover:drop-shadow-none'>
